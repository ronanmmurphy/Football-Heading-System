...
import com.example.ronan.heading_app.bluetooth.BleScanner;
import com.example.ronan.heading_app.bluetooth.ScanResultsConsumer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                try {
                    ble_device_list_adapter.getDevice(position+1);
                }
                catch (Exception e) {
                    Toast.makeText(getApplicationContext(), "Not enough devices", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                BluetoothDevice device_2 = ble_device_list_adapter.getDevice(position+1);
                if (toast != null) {
                    toast.cancel();
                }

                if (device_1.getName().equalsIgnoreCase("HEAD_ARD") && device_2.getName().equalsIgnoreCase("BALL_ARD")) {
                ...
                if (device_2.getName().equalsIgnoreCase("HEAD_ARD") && device_1.getName().equalsIgnoreCase("BALL_ARD")) {
                    Intent intent = new Intent(MainActivity.this, PeripheralControlActivity.class);
